...
package com.sillylife.sillynews.utils.xcardview;
...
public class CardView extends FrameLayout {
    ...
    private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        boolean showCardViewDefaultShadow = a.getBoolean(R.styleable.CardView_showCardViewDefaultShadow, false);
        a.recycle();
        if (!showCardViewDefaultShadow) {
            IMPL = new CardViewBaseImpl();
            IMPL.initStatic();
        }
